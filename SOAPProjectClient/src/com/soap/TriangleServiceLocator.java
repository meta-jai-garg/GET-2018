...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements com.soap.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8082/SOAPProject/services/Triangle";
    ...
    public com.soap.Triangle getTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public com.soap.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soap.TriangleSoapBindingStub _stub = new com.soap.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soap.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soap.TriangleSoapBindingStub _stub = new com.soap.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.com", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.com", "Triangle"));
        }
